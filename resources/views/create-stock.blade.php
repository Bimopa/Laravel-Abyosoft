...
<div class="w3-padding-large" id="main">
  ...
  <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
    <h1 class="w3-jumbo"><span class="w3-hide-small"></span>Tambah Stock</h1>
  </header>
    ...
    <form action="/create-stock" Method="POST">
        ...
        <select class="w3-input w3-padding-16" name="kodebrg">
          <option value="">---pilih kode barang---</option>
          
          @foreach ($barang as $data)
          <option value="{{$data->kodebrg}}">
              {{$data->kodebrg}}
          </option>
          @endforeach
        </select>
        ...
        <input class="w3-input w3-padding-16" type="text" required name="qtybeli" placeholder="Masukkan qty beli">
        <br>
