...
<div class="w3-padding-large" id="main">
  ...
  <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
    <h1 class="w3-jumbo"><span class="w3-hide-small"></span>Suplier</h1>
  </header>

    <form action="/create-suplier-view" method="GET">
    <button class="w3-button w3-light-grey w3-padding-large w3-section">
      <i class="fa fa-download"></i> Tambah Suplier </button>
    </form>

    <!-- Grid for pricing tables -->
    <h3 class="w3-padding-16 w3-text-light-grey">Daftar Suplier</h3>
    <table>
        <tr>
          <th>Kode Suplier</th>
          <th>Nama Suplier</th>
