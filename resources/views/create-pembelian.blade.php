...
<div class="w3-padding-large" id="main">
  ...
  <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
    <h1 class="w3-jumbo"><span class="w3-hide-small"></span>Tambah Pembelian</h1>
  </header>
    
    <!-- Grid for pricing tables -->
    <form action="/action_page.php" target="_blank">
        <label for="">Nama Barang</label>
        <input class="w3-input w3-padding-16" type="text" required name="Name" placeholder="Masukkan nama barang">
<br>
        <label for="">Kode Suplier</label>
        <select class="w3-input w3-padding-16" placeholder="Kode Suplier" required name="cars">
        ...
        <p>
          <button class="w3-button w3-light-grey w3-padding-large" type="submit">
            <i class="fa fa-download"></i> BELI </button>
        </p>
      </form>
